...
public class ObjImporter
{
    ...
    public Mesh ImportFile(string txt)
    {
        meshStruct newMesh = createMeshStruct(txt);
        populateMeshStruct(ref newMesh,txt);
    ...
    private static meshStruct createMeshStruct(string txt)
    {
        int triangles = 0;
        int vertices = 0;
        int vt = 0;
    ...
    private static void populateMeshStruct(ref meshStruct mesh,string txt)
    {
        using (StringReader reader = new StringReader(txt))
        {
            string currentText = reader.ReadLine();
