...
public class ASCLBasicController : MonoBehaviour
{
	...
	void LateUpdate () 
	{
		...
		//
		//
		if(false)//hitCheck is a boolean variable, it gets set by mecanim attack states, if mecanim set it...then we need to do hit checks right now
		{
